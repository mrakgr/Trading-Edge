...
//
// Usage:
//   dotnet run --project TradingEdge.ReplaySimulatorV2 -- <day-dir>
//
// e.g.
//   dotnet run --project TradingEdge.ReplaySimulatorV2 -- data/databento/mbo/EOSE/2026-05-13
//
...
let private summarizeBook (book: L3Book) =
    ...
    let levelStr (p, q: Level) =
        let totalSize = q |> Map.toSeq |> Seq.sumBy (fun (_, o) -> int64 o.Size)
...
let main argv =
    if argv.Length <> 1 then
        eprintfn "Usage: TradingEdge.ReplaySimulatorV2 <day-dir>"
