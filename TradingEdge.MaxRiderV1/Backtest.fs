...
let header =
    ...
    + "vwap_at_entry,dist_vwap,dist_vwap_z,dist_vwap_z_log,vol_z_log,vol_z_lin,ema_at_entry,pct_chg_since_open,chg_1d,chg_3d,"
...
let private row (t: Trip) =
    ...
    String.Join(",",
        [| t.Symbol
           ...
           f t.VwapAtEntry; f t.DistVwap; f t.DistVwapZ; f t.DistVwapZLog; f t.VolZLog; f t.VolZLin; f t.EmaAtEntry
