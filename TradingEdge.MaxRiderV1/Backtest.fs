...
let header =
    ...
    + "vwap_at_entry,dist_vwap,dist_vwap_z,dist_vwap_z_log,is_new_sess_high,prev_sess_vol_high,is_new_sess_vol_high,vol_z_log,vol_z_lin,ema_at_entry,pct_chg_since_open,chg_1d,chg_3d,"
