...
type FlushPosition =
    { SignalSec: int             // the gate bar (features captured here)
      ...
      // ⭐⭐ S43 z-QUANTILE COUNTERS (2026-09-02). zq_{sum|dec}_z{ZW}_t{T}_{H} =
      // rolling exceedance tallies (SumMa / DecaySumMa hl=H/2) of |z|>T, z taken
      // on ln(vwap) against a trailing ZW-bar window. zq_sess_* / zq_lo{N}_* =
      // ANCHORED tallies (session / a new N-bar channel low), carried as BOTH
      // count and the span-free RATE — ⚠ ALWAYS condition on the *_bars span.
      // See ZLadder in RollingMa for the √3 wall: rungs >= 1.7321 are reachable
      // only by CONVEXITY or a JUMP, so they read as ANTI-trend.
      ZqSumZ300T1_0W1200: float
      ZqDecZ300T1_0W1200: float
      ZqSumZ300T1_0W3600: float
      ZqDecZ300T1_0W3600: float
      ZqSumZ300T1_5W1200: float
      ZqDecZ300T1_5W1200: float
      ZqSumZ300T1_5W3600: float
      ZqDecZ300T1_5W3600: float
      ZqSumZ300T1_7W1200: float
      ZqDecZ300T1_7W1200: float
      ZqSumZ300T1_7W3600: float
      ZqDecZ300T1_7W3600: float
      ZqSumZ300T2_0W1200: float
      ZqDecZ300T2_0W1200: float
      ZqSumZ300T2_0W3600: float
      ZqDecZ300T2_0W3600: float
      ZqSumZ300T2_5W1200: float
      ZqDecZ300T2_5W1200: float
      ZqSumZ300T2_5W3600: float
      ZqDecZ300T2_5W3600: float
      ZqSumZ300T3_0W1200: float
      ZqDecZ300T3_0W1200: float
      ZqSumZ300T3_0W3600: float
      ZqDecZ300T3_0W3600: float
      ZqSumZ1200T1_0W1200: float
      ZqDecZ1200T1_0W1200: float
      ZqSumZ1200T1_0W3600: float
      ZqDecZ1200T1_0W3600: float
      ZqSumZ1200T1_5W1200: float
      ZqDecZ1200T1_5W1200: float
      ZqSumZ1200T1_5W3600: float
      ZqDecZ1200T1_5W3600: float
      ZqSumZ1200T1_7W1200: float
      ZqDecZ1200T1_7W1200: float
      ZqSumZ1200T1_7W3600: float
      ZqDecZ1200T1_7W3600: float
      ZqSumZ1200T2_0W1200: float
      ZqDecZ1200T2_0W1200: float
      ZqSumZ1200T2_0W3600: float
      ZqDecZ1200T2_0W3600: float
      ZqSumZ1200T2_5W1200: float
      ZqDecZ1200T2_5W1200: float
      ZqSumZ1200T2_5W3600: float
      ZqDecZ1200T2_5W3600: float
      ZqSumZ1200T3_0W1200: float
      ZqDecZ1200T3_0W1200: float
      ZqSumZ1200T3_0W3600: float
      ZqDecZ1200T3_0W3600: float
      ZqSessCntT1_0: float
      ZqSessRateT1_0: float
      ZqSessCntT1_5: float
      ZqSessRateT1_5: float
      ZqSessCntT1_7: float
      ZqSessRateT1_7: float
      ZqSessCntT2_0: float
      ZqSessRateT2_0: float
      ZqSessCntT2_5: float
      ZqSessRateT2_5: float
      ZqSessCntT3_0: float
      ZqSessRateT3_0: float
      ZqSessBars: int
      ZqLo180CntT1_0: float
      ZqLo180RateT1_0: float
      ZqLo180CntT1_5: float
      ZqLo180RateT1_5: float
      ZqLo180CntT1_7: float
      ZqLo180RateT1_7: float
      ZqLo180CntT2_0: float
      ZqLo180RateT2_0: float
      ZqLo180CntT2_5: float
      ZqLo180RateT2_5: float
      ZqLo180CntT3_0: float
      ZqLo180RateT3_0: float
      ZqLo180Bars: int
      ZqLo300CntT1_0: float
      ZqLo300RateT1_0: float
      ZqLo300CntT1_5: float
      ZqLo300RateT1_5: float
      ZqLo300CntT1_7: float
      ZqLo300RateT1_7: float
      ZqLo300CntT2_0: float
      ZqLo300RateT2_0: float
      ZqLo300CntT2_5: float
      ZqLo300RateT2_5: float
      ZqLo300CntT3_0: float
      ZqLo300RateT3_0: float
      ZqLo300Bars: int
      ZqLo600CntT1_0: float
      ZqLo600RateT1_0: float
      ZqLo600CntT1_5: float
      ZqLo600RateT1_5: float
      ZqLo600CntT1_7: float
      ZqLo600RateT1_7: float
      ZqLo600CntT2_0: float
      ZqLo600RateT2_0: float
      ZqLo600CntT2_5: float
      ZqLo600RateT2_5: float
      ZqLo600CntT3_0: float
      ZqLo600RateT3_0: float
      ZqLo600Bars: int
      ZqLo1200CntT1_0: float
      ZqLo1200RateT1_0: float
      ZqLo1200CntT1_5: float
      ZqLo1200RateT1_5: float
      ZqLo1200CntT1_7: float
      ZqLo1200RateT1_7: float
      ZqLo1200CntT2_0: float
      ZqLo1200RateT2_0: float
      ZqLo1200CntT2_5: float
      ZqLo1200RateT2_5: float
      ZqLo1200CntT3_0: float
      ZqLo1200RateT3_0: float
      ZqLo1200Bars: int
      ZBar300: float
      ZBar1200: float
...
type IntradaySystem(cfg: IntradayConfig, ticker: string, day: DateOnly) =
    ...
    // ⭐⭐ S43 (user, 2026-09-02): Z-QUANTILE COUNTERS — trend strength via the
    // count of bars whose |z| clears each rung of a ladder. z is bar-clock on
    // ln(vwap) (scale-invariant: the universe has no price floor), measured
    // against a trailing REFERENCE window; the COUNT horizon is deliberately a
    // SEPARATE, longer window. See the ZLadder doc block for the √3 wall — the
    // rungs at/above 1.7321 can only be reached by CONVEXITY or a JUMP, never
    // by a clean trend however steep, so they read as ANTI-trend.
    // ⚠ On a clean trend the SUB-wall rungs SATURATE (every warm bar shares one
    // z, the newest bar being its own window's extreme) — the discrimination is
    // expected to sit at 2.0/2.5/3.0.
    let zThresholds = [| 1.0; 1.5; 1.7; 2.0; 2.5; 3.0 |]
    let zNT = zThresholds.Length
    let zLad300 = ZLadder(300, zThresholds)     // 5m reference window
    let zLad1200 = ZLadder(1200, zThresholds)   // 20m reference window
    // ROLLING count horizons — SumMa (flat) and DecaySumMa (recency-weighted,
    // hl = half the horizon) per rung per z-window. gapCount 0 throughout: this
    // is a PRICE feature and price features stay bar-clock in both engines.
    let zRollWins = [| 1200; 3600 |]            // 20m, 60m
    let zSum = Array2D.init 2 zNT (fun _ _ -> [| SumMa 1200; SumMa 3600 |])
    let zDec =
        Array2D.init 2 zNT (fun _ _ ->
            [| DecaySumMa(600.0, GapValue.Zero); DecaySumMa(1800.0, GapValue.Zero) |])
    // ANCHORED (session + the four channel lows). The session one is anchored at
    // 09:30 and never reset; the four re-anchor on a NEW CHANNEL LOW, mirroring
    // the effSinceLow/olsSinceLow convention (reset then push THIS bar, so the
    // anchoring bar counts INTO the segment).
    // ⚠ RATE not COUNT — the rate is span-free on the null (L 60->4800: t=2.0
    // 0.159 -> 0.150) whereas the count scales linearly. Still RECORD .Bars and
    // condition on it (the S43aj/ak lesson: span-free under the null is not
    // span-free in the data). W=300 only, by design: the anchor already supplies
    // the long horizon.
    let zMinAnchorBars = 30                     // fail-closed floor (AnchoredEff's slots<3 twin)
    let zAncSess = AnchoredZCount(zNT, zMinAnchorBars)
    let zAncLows = [| 180; 300; 600; 1200 |]    // 3m, 5m, 10m, 20m channel lows
    let zAncLow = Array.init 4 (fun _ -> AnchoredZCount(zNT, zMinAnchorBars))
    let volatRoller =
        WindowRoller<float>(
    ...
    member this.Process (bar: SecBar) =
        ...
        // ⭐ z-quantile ANCHOR RESETS — a new N-bar channel LOW re-anchors that
        // segment. Mirrors the effSinceLow convention: Reset() then push THIS
        // bar, so the anchoring bar counts INTO the new segment. Evaluated on
        // the STRICTLY-PRIOR mins (sMinX180/sMin300/sMin600/sMin1200), the same
        // snapshots isNewLow uses, so "new low" means the same thing everywhere.
        if bar.vwap > 0.0 then
            let priorLows = [| sMinX180; sMin300; sMin600; sMin1200 |]
            for a in 0 .. 3 do
                match priorLows.[a] with
                | ValueSome lo when bar.vwap < lo -> zAncLow.[a].Reset()
                | _ -> ()
        // ⭐ z-quantile: evaluate each ladder ONCE, then fan the indicators out.
        if bar.vwap > 0.0 then
            let lp = log bar.vwap
            zLad300.Push lp
            zLad1200.Push lp
            let i300 = zLad300.Indicators
            let i1200 = zLad1200.Indicators
            let inds = [| i300; i1200 |]
            for z in 0 .. 1 do
                let ind = inds.[z]
                for k in 0 .. zNT - 1 do
                    for w in 0 .. 1 do
                        zSum.[z, k].[w].Push ind.[k]
                        zDec.[z, k].[w].Push(ind.[k], 0)
            // anchored counters ride the 5m-reference ladder only
            zAncSess.Push i300
            for a in 0 .. 3 do zAncLow.[a].Push i300
            ...
            pendingEntry <-
                ValueSome
                    { SignalSec = bar.etSec
                      ...
                      ZqSumZ300T1_0W1200 = vv zSum.[0, 0].[0].State
                      ZqDecZ300T1_0W1200 = vv zDec.[0, 0].[0].Sum
                      ZqSumZ300T1_0W3600 = vv zSum.[0, 0].[1].State
                      ZqDecZ300T1_0W3600 = vv zDec.[0, 0].[1].Sum
                      ZqSumZ300T1_5W1200 = vv zSum.[0, 1].[0].State
                      ZqDecZ300T1_5W1200 = vv zDec.[0, 1].[0].Sum
                      ZqSumZ300T1_5W3600 = vv zSum.[0, 1].[1].State
                      ZqDecZ300T1_5W3600 = vv zDec.[0, 1].[1].Sum
                      ZqSumZ300T1_7W1200 = vv zSum.[0, 2].[0].State
                      ZqDecZ300T1_7W1200 = vv zDec.[0, 2].[0].Sum
                      ZqSumZ300T1_7W3600 = vv zSum.[0, 2].[1].State
                      ZqDecZ300T1_7W3600 = vv zDec.[0, 2].[1].Sum
                      ZqSumZ300T2_0W1200 = vv zSum.[0, 3].[0].State
                      ZqDecZ300T2_0W1200 = vv zDec.[0, 3].[0].Sum
                      ZqSumZ300T2_0W3600 = vv zSum.[0, 3].[1].State
                      ZqDecZ300T2_0W3600 = vv zDec.[0, 3].[1].Sum
                      ZqSumZ300T2_5W1200 = vv zSum.[0, 4].[0].State
                      ZqDecZ300T2_5W1200 = vv zDec.[0, 4].[0].Sum
                      ZqSumZ300T2_5W3600 = vv zSum.[0, 4].[1].State
                      ZqDecZ300T2_5W3600 = vv zDec.[0, 4].[1].Sum
                      ZqSumZ300T3_0W1200 = vv zSum.[0, 5].[0].State
                      ZqDecZ300T3_0W1200 = vv zDec.[0, 5].[0].Sum
                      ZqSumZ300T3_0W3600 = vv zSum.[0, 5].[1].State
                      ZqDecZ300T3_0W3600 = vv zDec.[0, 5].[1].Sum
                      ZqSumZ1200T1_0W1200 = vv zSum.[1, 0].[0].State
                      ZqDecZ1200T1_0W1200 = vv zDec.[1, 0].[0].Sum
                      ZqSumZ1200T1_0W3600 = vv zSum.[1, 0].[1].State
                      ZqDecZ1200T1_0W3600 = vv zDec.[1, 0].[1].Sum
                      ZqSumZ1200T1_5W1200 = vv zSum.[1, 1].[0].State
                      ZqDecZ1200T1_5W1200 = vv zDec.[1, 1].[0].Sum
                      ZqSumZ1200T1_5W3600 = vv zSum.[1, 1].[1].State
                      ZqDecZ1200T1_5W3600 = vv zDec.[1, 1].[1].Sum
                      ZqSumZ1200T1_7W1200 = vv zSum.[1, 2].[0].State
                      ZqDecZ1200T1_7W1200 = vv zDec.[1, 2].[0].Sum
                      ZqSumZ1200T1_7W3600 = vv zSum.[1, 2].[1].State
                      ZqDecZ1200T1_7W3600 = vv zDec.[1, 2].[1].Sum
                      ZqSumZ1200T2_0W1200 = vv zSum.[1, 3].[0].State
                      ZqDecZ1200T2_0W1200 = vv zDec.[1, 3].[0].Sum
                      ZqSumZ1200T2_0W3600 = vv zSum.[1, 3].[1].State
                      ZqDecZ1200T2_0W3600 = vv zDec.[1, 3].[1].Sum
                      ZqSumZ1200T2_5W1200 = vv zSum.[1, 4].[0].State
                      ZqDecZ1200T2_5W1200 = vv zDec.[1, 4].[0].Sum
                      ZqSumZ1200T2_5W3600 = vv zSum.[1, 4].[1].State
                      ZqDecZ1200T2_5W3600 = vv zDec.[1, 4].[1].Sum
                      ZqSumZ1200T3_0W1200 = vv zSum.[1, 5].[0].State
                      ZqDecZ1200T3_0W1200 = vv zDec.[1, 5].[0].Sum
                      ZqSumZ1200T3_0W3600 = vv zSum.[1, 5].[1].State
                      ZqDecZ1200T3_0W3600 = vv zDec.[1, 5].[1].Sum
                      ZqSessCntT1_0 = zAncSess.Count 0
                      ZqSessRateT1_0 = zAncSess.Rate 0
                      ZqSessCntT1_5 = zAncSess.Count 1
                      ZqSessRateT1_5 = zAncSess.Rate 1
                      ZqSessCntT1_7 = zAncSess.Count 2
                      ZqSessRateT1_7 = zAncSess.Rate 2
                      ZqSessCntT2_0 = zAncSess.Count 3
                      ZqSessRateT2_0 = zAncSess.Rate 3
                      ZqSessCntT2_5 = zAncSess.Count 4
                      ZqSessRateT2_5 = zAncSess.Rate 4
                      ZqSessCntT3_0 = zAncSess.Count 5
                      ZqSessRateT3_0 = zAncSess.Rate 5
                      ZqSessBars = zAncSess.Bars
                      ZqLo180CntT1_0 = zAncLow.[0].Count 0
                      ZqLo180RateT1_0 = zAncLow.[0].Rate 0
                      ZqLo180CntT1_5 = zAncLow.[0].Count 1
                      ZqLo180RateT1_5 = zAncLow.[0].Rate 1
                      ZqLo180CntT1_7 = zAncLow.[0].Count 2
                      ZqLo180RateT1_7 = zAncLow.[0].Rate 2
                      ZqLo180CntT2_0 = zAncLow.[0].Count 3
                      ZqLo180RateT2_0 = zAncLow.[0].Rate 3
                      ZqLo180CntT2_5 = zAncLow.[0].Count 4
                      ZqLo180RateT2_5 = zAncLow.[0].Rate 4
                      ZqLo180CntT3_0 = zAncLow.[0].Count 5
                      ZqLo180RateT3_0 = zAncLow.[0].Rate 5
                      ZqLo180Bars = zAncLow.[0].Bars
                      ZqLo300CntT1_0 = zAncLow.[1].Count 0
                      ZqLo300RateT1_0 = zAncLow.[1].Rate 0
                      ZqLo300CntT1_5 = zAncLow.[1].Count 1
                      ZqLo300RateT1_5 = zAncLow.[1].Rate 1
                      ZqLo300CntT1_7 = zAncLow.[1].Count 2
                      ZqLo300RateT1_7 = zAncLow.[1].Rate 2
                      ZqLo300CntT2_0 = zAncLow.[1].Count 3
                      ZqLo300RateT2_0 = zAncLow.[1].Rate 3
                      ZqLo300CntT2_5 = zAncLow.[1].Count 4
                      ZqLo300RateT2_5 = zAncLow.[1].Rate 4
                      ZqLo300CntT3_0 = zAncLow.[1].Count 5
                      ZqLo300RateT3_0 = zAncLow.[1].Rate 5
                      ZqLo300Bars = zAncLow.[1].Bars
                      ZqLo600CntT1_0 = zAncLow.[2].Count 0
                      ZqLo600RateT1_0 = zAncLow.[2].Rate 0
                      ZqLo600CntT1_5 = zAncLow.[2].Count 1
                      ZqLo600RateT1_5 = zAncLow.[2].Rate 1
                      ZqLo600CntT1_7 = zAncLow.[2].Count 2
                      ZqLo600RateT1_7 = zAncLow.[2].Rate 2
                      ZqLo600CntT2_0 = zAncLow.[2].Count 3
                      ZqLo600RateT2_0 = zAncLow.[2].Rate 3
                      ZqLo600CntT2_5 = zAncLow.[2].Count 4
                      ZqLo600RateT2_5 = zAncLow.[2].Rate 4
                      ZqLo600CntT3_0 = zAncLow.[2].Count 5
                      ZqLo600RateT3_0 = zAncLow.[2].Rate 5
                      ZqLo600Bars = zAncLow.[2].Bars
                      ZqLo1200CntT1_0 = zAncLow.[3].Count 0
                      ZqLo1200RateT1_0 = zAncLow.[3].Rate 0
                      ZqLo1200CntT1_5 = zAncLow.[3].Count 1
                      ZqLo1200RateT1_5 = zAncLow.[3].Rate 1
                      ZqLo1200CntT1_7 = zAncLow.[3].Count 2
                      ZqLo1200RateT1_7 = zAncLow.[3].Rate 2
                      ZqLo1200CntT2_0 = zAncLow.[3].Count 3
                      ZqLo1200RateT2_0 = zAncLow.[3].Rate 3
                      ZqLo1200CntT2_5 = zAncLow.[3].Count 4
                      ZqLo1200RateT2_5 = zAncLow.[3].Rate 4
                      ZqLo1200CntT3_0 = zAncLow.[3].Count 5
                      ZqLo1200RateT3_0 = zAncLow.[3].Rate 5
                      ZqLo1200Bars = zAncLow.[3].Bars
                      ZBar300 = zLad300.Z
                      ZBar1200 = zLad1200.Z
