module TradingEdge.MaxFader.Program

open System
open System.Diagnostics
open Argu
open TradingEdge.MaxFader.Backtest
...
/// MaxFader CLI. Deliberately TINY (the DipRiderV6 discipline): this is a
...
[<EntryPoint>]
let main argv =
    let parser = ArgumentParser.Create<Args>(programName = "TradingEdge.MaxFader")
    let parsed =
    ...
    printfn "MaxFader — 1s SHORT pop-fade, HOLD TO CLOSE (MaxFlyerV2 ported to the tape)"
    printfn "  db          = %s" dbPath
