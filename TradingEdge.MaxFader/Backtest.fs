module TradingEdge.MaxFader.Backtest
...
open TradingEdge.MaxFader.Intraday

// ===========================================================================
// MaxFader backtest wiring (template: DipRiderV6/Backtest.fs via SurgeRider).
//
...
/// MaxFader config = the intraday engine knobs + notional + the daily floor.
type Config =
...
/// Run the whole MaxFader sampler: candidates from trading.db (pipeline 1),
