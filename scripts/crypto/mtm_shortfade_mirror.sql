-- MTM decomposition for ShortFadeMA simple mirror (no 200h CVD overlay).
-- Sister of mtm_flowswing.sql, short-side sign.
...
SELECT 'shortmirror' AS variant, symbol, side, entry_price, exit_price, effective_notional, fees,
       funding_pnl, net_pnl,
...
FROM read_csv_auto('data/crypto/short_fade_ma_mirror/results_trips_1m_pr0.14_ma72h_cvd240m_rvol0.75_ed0.2_short.csv');
...
) TO 'data/crypto/short_fade_ma_mirror/mtm_monthly.csv' (HEADER, DELIMITER ',');
