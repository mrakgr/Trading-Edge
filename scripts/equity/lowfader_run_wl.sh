...
cd /home/mrakgr/Trading-Edge/research; START=${1:?}; END=${2:?}; TAG=${3:?}; OUT=data/lowfader_wl_$TAG; rm -rf $OUT
FF_CANDIDATE_TABLE=lowfader_whitelist DOTNET_GCHeapHardLimitPercent=55 ./TradingEdge.LowFader/bin/Release/net10.0/TradingEdge.LowFader \
