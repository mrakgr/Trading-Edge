...
type Args =
    ...
    interface IArgParserTemplate with
        member s.Usage =
            ...
            | Min_Max_Atr_Log _ -> "Min 'max log ATR' = 126-bar max of the 14-bar log-ATR (past-runner volatility-history FLOOR). Default 0.04. Cuts dead-quiet-base names. 0 disables."
