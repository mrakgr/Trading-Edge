...
Note that previous version of the document had experiments using the `brv20d` feature which had lookahead 
they have been removed. Look in the source control for historical reference.

Even some of the results the results involving rvol in this document are poisoned by the data leak, but
