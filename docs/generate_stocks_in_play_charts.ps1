...
foreach ($file in $Files) {
    ...
    if ($file.SecondsPerBar) {
        Write-Host "<div class=""chart-placeholder"" data-src=""charts/${basename}_intraday_timebar.html"" style=""width:100%; height:600px; border:1px solid #ccc; display:flex; align-items:center; justify-content:center; cursor:pointer; background:#f5f5f5;"">Click to load chart</div>"
    }
    Write-Host ""
