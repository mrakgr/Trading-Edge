# Why I am dropping v0 of document here

You know after all is said and done, I don't like this. Here I am trying to grade the catalysts, but these numbers are completely meaningless. I am just pulling them out of my ass, and it's ambiguous what I am even grading them on.

Instead what would be actually useful if I could simply categorize them. Not on a scale from 1-10, but it's useful to know if something is a surprise or a major surprise. We should score the catalysts into earnings surprises: standard and major. We can also categorize deals into standard and major. For biotechs, we might also have FDA approvals (phase 1,2,3)

We can have buyouts as a category, but we don't want those examples in our reference book.

As for technical analysis instead of putting these useless numbers here, what we should do is categorize the price action into different types. Like, is it a jumpy momentum stock? Is it a pump and dump? Is it an exhaustion top? Is it a breakout from a consolidation or is the stock already in an uptrend. I know SMB teaches its traders to put levels, but that info would be literally useless to myself and my systems. But it would be very useful to know the overall momentum of the stock, and the pattern that is precending the day.

As for orderflow analysis, we don't need to write anything here at all.

The actual work going into that should be done on the trading system side. Let me try doing the document anew without necessarily writing these essays.

Instead I should aim for a simple, bare bones document where I have the relevant facts and categories that could be widely considered to be subjective. This will both be more useful to my quant work, and will make my work a lot faster since I won't have to write down so much text.
...
Short %: 40.2%
Catalyst: 8/10 (continued selloff)

Quality: 8/10.

Because the previous day was so good in terms of its order flow, the **Second Day** play is actually better than the earnings miss in my view.
...
If every stock was like this it would be easy to hit a million. The premarket volume didn't matter too much as the activity picked up subtantially after the open. If you look at the stock, there were plenty of holds that were each broken in turn. A beautiful chart.
...
For once we have a low float stock. I am noticing that a lot of these minor earnings plays seem to have very good price action. Mike Bellafiore says to avoid high short % stocks, but a lot of these plays seem to have high short interest.

### Technical Analysis

<iframe src="charts/ULTA_2026-03-13_daily.html" width="100%" height="100%" style="border: 1px solid #ccc;"></iframe>

Broadly speaking, it is selling off into the previous suppor area.
...
Because the previous day had such good trending price action, it followed through into the current day.
...
It took a while for it to break support, but it turned into a decent trade once it did. Not sure whether I should be trading in the middle of the day in general.