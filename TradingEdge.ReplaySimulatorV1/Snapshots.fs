module TradingEdge.ReplaySimulatorV1.Snapshots
...
let buildAsync (merged: IAsyncEnumerable<MboMsg>) : Task<SnapshotStore> = task {
    ...
    // Mutable scratch state for the build pass.
    let books = Dictionary<int, MutableBook>()
