...
type Args =
    ...
    interface IArgParserTemplate with
        member s.Usage =
            ...
            | Stop_Low_Window _ -> "Trailing-stop low window in bars. Default 4 (the locked sweet spot)."
            | Trail_Window _ -> "Trailing-limit N-day-high window. Default 1 (N=1)."
...
let main argv =
    ...
    printfn "  stop win  = %d   trail N = %d   expansion = %.2f"
        cfg.StopLowWindow cfg.TrailWindow cfg.ExpansionThr
