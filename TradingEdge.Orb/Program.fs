...
// $0.005/share for the (Tv, Ta) backtest — the new system trades much less
// frequently than the old RVOL-3 baseline so we use a more realistic IBKR
// tiered assumption. Prior docs that quote PF 1.87 at $0.0035/share will
// need to be re-run for apples-to-apples comparisons.
