...
let tripsHeader =
    "symbol,timeframe,ma_hours,allow_short,entry_us,exit_us,side,entry_price,exit_price,net_pnl,fees,bars_held,mfe,mae,ratio_at_entry,effective_notional,funding_pnl,adv_at_entry,price_rise_at_entry"
...
let private donchianTripRow
    ...
    String.concat "," [
        ...
        fmt t.DollarVolume5mAtEntry
        fmt t.TradeCount5mAtEntry
